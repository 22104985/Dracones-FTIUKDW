     ...
     <li><a href="index.php">Beranda</a></li>
      ...
      <li><a href="produk.php">Produk</a></li>
        ...
        <div id="content">
                ...
                <h1>Keterangan COD</h1>
              
                 <ul  >
	 <li>Pembeli akan di hubungi oleh pihak toko</li>
     <li>Menentukan waktu dan tempat cod</li>
     <li>Pembeli dan pihak toko sepakat melakuakn cod</li>
