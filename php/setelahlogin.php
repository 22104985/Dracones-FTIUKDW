...
var msg = "Selamat datang Mr.Satu ^__^";
var out = "";
        ...
        <div id="header"><img src="../images/logo.png" width="511" height="80">
            <p id="trblock">
              <a href="" id="scart">Keranjang Belanja</a><br>
                        <a href="" id="user" >Mr.Satu</a>
                        <a href="logout.php" id="logout" > Keluar</a>
...
<a href=""><img src="../images/photo1.jpg"   width="650" height="400" class="active"/></a>
