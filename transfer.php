     ...
     <li><a href="index.php">Beranda</a></li>
      ...
      <li><a href="produk.php">Produk</a></li>
        ...
        <div id="content">
                ...
                <h1>Keterangan Transfer</h1>
              
                 <ul class="met" >
	 <li>BCA 02974872482734</li>
     <li>MANDIRI 1528796998</li>
     <li>BNI 638353535</li>
     <li>BRI 53535250000</li>
     
     <li>Semua no rek diatas atas nama Dracones</li>
     <li>Lakukan konfirmasi setelah melakukan pembayaran ke no sekian</li>
    <li>0274-556677</li>
    <li>0852-5000-0000</li>
